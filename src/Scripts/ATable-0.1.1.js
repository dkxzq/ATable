(function() {
    ...
    AlanTable.prototype = {
        ...
        option: {
            ...
            fistpageimg: "/images/icons/arrow_start.png",
            lastpageimg: "/images/icons/arrow_end.png",
            prevpageimg: "/images/icons/arrow__180.png",
            nextpageimg: "/images/icons/arrow.png",

            fistpageimg_unable: "/images/icons/arrow_starts.png",
            lastpageimg_unable: "/images/icons/arrow_ends.png",
            prevpageimg_unable: "/images/icons/arrow__180s.png",
            nextpageimg_unable: "/images/icons/arrows.png",

            refushimg: "/images/icons/arrow_circle_double.png",
            exportpageimg: "/images/icons/Export.png",
            exportallimg: "/images/icons/document-excel-csv.png",
            showpagefoot: true,
            showexport: true,
        },
    };
    ...
    AlanTable.prototype.CreateSortJson = function() {
        var jsonSortStr = '';
        if (this.sort != null && this.sort != '') {
            var sortJson = {};
            sortJson.property = this.sort;
            sortJson.direction = this.sortDesc ? "DESC" : "ASC";
            jsonSortStr = JSON.stringify(sortJson);
        }
        return jsonSortStr;
    }
    ...
    AlanTable.prototype.CreateURLParams = function() {
        ...
        if (this.option.allowsort) {
            result += "&sort=[" + this.CreateSortJson() + "]";
        }
        return result;
    }
    ...
    $.fn.TransAlanTable = function(serviceURL, params, filter, columns, options, toolbars, operations) {
        ...
        atable.option = $.extend({}, atable.option, {
            ...
            panelboxstyle: 'PanelTitle',
            toolbarstyle: 'ToolBar',
            operationtitle: 'OperationBar',
        }, options);
